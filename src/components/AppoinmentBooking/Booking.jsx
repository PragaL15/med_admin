    ...
    const fetchData = async () => {
      try {
        const response = await axiosInstance.get(
          "/api/appointments/doctors-patients"
        );
          ...
          <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
            <div className="ml-4">
              ...
              <Dropdown
                ...
                onChange={(e) =>
                  setFormData((prev) => ({ ...prev, p_id: e.value }))
                }
                name="p_id"
            ...
            <div className="ml-4">
              ...
              <Dropdown
                ...
                onChange={(e) =>
                  setFormData((prev) => ({ ...prev, d_id: e.value }))
                }
                name="d_id"
                className="input-class-drop"
            ...
            <div className="ml-4">
              ...
              <div className="flex items-center relative w-full">
                <InputText
                  type="text"
                  value={
                    formData.app_date && formData.time
                      ? `Date: ${formData.app_date} Time: ${formData.time}`
                      : ""
                  }
                  ...
                  <div className="absolute top-10 left-0 bg-white inline">
                    <Calendar
                      value={
                        tempDateTime ||
                        (formData.app_date && formData.time
                          ? new Date(`${formData.app_date}T${formData.time}`)
                          : null)
                      }
            ...
            <div className="ml-4">
              ...
              <InputText
                ...
                onChange={(e) =>
                  setFormData((prev) => ({ ...prev, p_health: e.target.value }))
                }
                name="p_health"
                className="input-class-inp"
